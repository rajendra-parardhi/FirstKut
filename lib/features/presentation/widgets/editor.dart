...
import 'package:firstkut/features/presentation/widgets/monoca.dart';
...
class _EditorWidgetState extends State<EditorWidget> {
  int refreshKey = 0; // 🔥 forces rebuild
        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                onTap: () =>
                    bloc.downloadFileAt(state.selectedIndex),
                borderRadius: BorderRadius.circular(12),
                child: Container(
                  height: 48,
                  padding:
          ...
          Expanded(
            child: Container(
              ...
              // 🔥 KEY BASED REBUILD (IMPORTANT)
              child: MonacoEditorWidget(
                key: ValueKey(refreshKey),
                code: bloc.controller.text,
              ),
            ),
          ),
        ],
